...
const ProjectCard = ({
  ...
  return (
    <div className="bg-light-blue-2 dark:bg-dark-blue text-white p-4 rounded-lg shadow-md w-full">
        ...
        <div className="flex space-x-5 text-navy dark:text-light-blue">
          {githubLink && (
            <a href={githubLink} target="_blank" rel="noopener noreferrer">
              <FaGithub className="hover:text-gray-300" size={28} />
            </a>
          )}
          {liveLink && (
            <a href={liveLink} target="_blank" rel="noopener noreferrer">
              <FaExternalLinkAlt className="hover:text-gray-300" size={28} />
            </a>
          )}
        </div>
      </div>
